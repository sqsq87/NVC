...
{
    printf("num = %d\n",num);
    char pmem_name[MAX_FILE_PATH] = "/home/vagrant/NVC/tests/crush_mem.out.";
    char pcache_name[MAX_FILE_PATH] = "/home/vagrant/NVC/tests/crush_cache.out.";
    char pconsistentvaribles_name[MAX_FILE_PATH] = "/home/vagrant/NVC/tests/consistent_variable.out.";
    ...
    FILE *pinfo = fopen("/home/vagrant/NVC/tests/malloctrace.out", "r+");
